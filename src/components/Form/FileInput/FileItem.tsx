      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-error-700 text-sm font-medium dark:text-error-300">
              Upload failed, please try again.
            </span>
            <span className="text-error-600 text-sm dark:text-error-400">{name}</span>
          </div>

          <button
            type="button"
            className="text-error-700 hover:text-error-700 text-sm font-semibold dark:text-error-300 dark:hover:text-error-300"
          >
            Try again
          </button>
        </div>
