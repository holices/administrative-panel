        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2 ">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Username" />
              </Input.Root>

              <div className="flex flex-col gap-3 lg:block">
                <label
                  htmlFor="lastName"
                  className="text-sm font-medium text-zinc-700 lg:sr-only dark:text-zinc-200"
                >
                  Last name
                </label>

                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Lastname" />
                </Input.Root>
              </div>
            </div>
            <div />
          ...
          <div className="flex flex-col gap-3 border-b border-zinc-200 pb-5 pt-5 lg:grid lg:grid-cols-form">
            <label
              htmlFor="email"
              className="text-sm font-medium text-zinc-700 dark:text-zinc-200"
            >
          ...
          <div className="flex flex-col gap-3 border-b border-zinc-200 pb-5 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              <Input.Control id="role" defaultValue="Example" />
            </Input.Root>
          </div>
